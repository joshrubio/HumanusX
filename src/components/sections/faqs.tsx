                ...
                <div className="row">
                    <div className="col-xl-12 col-lg-12">
                        <SectionTitle>
                            ...
                            <SectionTitle.Title>Common Questions</SectionTitle.Title>
                            <SectionTitle.Description>Everything you need to know about our services.</SectionTitle.Description>
                        </SectionTitle>
                    </div>
                </div>
                <div className="row">
