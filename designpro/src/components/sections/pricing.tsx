                    ...
                    <div className="row">
                        <div className="col-xl-12 col-lg-12">
                            <SectionTitle>
                                ...
                                <SectionTitle.Title>Partnership Models</SectionTitle.Title>
                                <SectionTitle.Description>Scalable solutions designed for your property's growth.</SectionTitle.Description>
                            </SectionTitle>
                        </div>
                    </div>
